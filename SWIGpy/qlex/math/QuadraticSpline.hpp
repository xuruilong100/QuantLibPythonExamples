...
namespace QuantLib {
    ...
    /*! Follows treatment from:
        ...
        For a \f$n\f$-parameter spline, client should offer \f$n\f$ knot points \f$k_l(1 \le l \le
       n)\f$, and set \f$k_1 = 0\f$, \f$k_n = M\f$, \f$M\f$ is the maximum maturity.
       ...
       \\
            {\frac{\left(k_{l}-k_{l-1}\right)}{2}+(t-k_l)^2
       -\frac{\left(t-k_{l}\right)^2}{2\left(k_{l+1}-k_{l}\right)}} & {k_{l} \le t<k_{l+1}} \\
