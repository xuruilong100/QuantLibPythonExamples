...
namespace QuantLib {
    ...
    ext::shared_ptr<DayCounter::Impl> Actual365_25::implementation(Actual365_25::Convention c) {
        switch (c) {
            case Standard:
    ...
    Date::serial_type Actual365_25::NL_Impl::dayCount(const Date& d1, const Date& d2) const {
