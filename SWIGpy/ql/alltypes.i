...
typedef FittedBondDiscountCurve::FittingMethod FittingMethod;
typedef HestonModel::FellerConstraint FellerConstraint;
...
typedef MarketModelMultiProduct::CashFlow MarketModelMultiProductCashFlow;
typedef MarketModelPathwiseMultiProduct::CashFlow MarketModelPathwiseMultiProductCashFlow;
typedef Matrix::row_iterator MatrixRow;
...
typedef TenorOptionletVTS::TwoParameterCorrelation TwoParameterCorrelation;
