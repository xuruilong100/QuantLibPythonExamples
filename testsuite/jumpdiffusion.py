...
class JumpDiffusionTest(unittest.TestCase):
    ...
    def testMerton76(self):
        TEST_MESSAGE(
            "Testing Merton 76 jump-diffusion model "
        ...
        values = [
            ...
            HaugMertonData(Option.Call, 80.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.25, 23.61, 1e-2),
            ...
            HaugMertonData(Option.Call, 90.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.25, 15.42, 1e-2),
            ...
            HaugMertonData(Option.Call, 100.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.25, 9.03, 1e-2),
            ...
            HaugMertonData(Option.Call, 110.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.25, 4.74, 1e-2),
            ...
            HaugMertonData(Option.Call, 120.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.25, 2.25, 1e-2),
            ...
            HaugMertonData(Option.Call, 80.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.50, 23.61, 1e-2),
            ...
            HaugMertonData(Option.Call, 90.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.50, 15.41, 1e-2),
            ...
            HaugMertonData(Option.Call, 100.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.50, 9.00, 1e-2),
            ...
            HaugMertonData(Option.Call, 110.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.50, 4.71, 1e-2),
            ...
            HaugMertonData(Option.Call, 120.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.50, 2.24, 1e-2),
            ...
            HaugMertonData(Option.Call, 80.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.75, 23.64, 1e-2),
            ...
            HaugMertonData(Option.Call, 90.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.75, 15.40, 1e-2),
            ...
            HaugMertonData(Option.Call, 100.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.75, 8.95, 1e-2),
            ...
            HaugMertonData(Option.Call, 110.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.75, 4.66, 1e-2),
            ...
            HaugMertonData(Option.Call, 120.00, 100.00, 0.00, 0.08, 0.50, 0.25, 10.0, 0.75, 2.23, 1e-2)]
