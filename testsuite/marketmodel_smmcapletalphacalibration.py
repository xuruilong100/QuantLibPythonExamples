...
class MarketModelSmmCapletAlphaCalibrationTest(unittest.TestCase):

    def testFunction(self):

        TEST_MESSAGE(
            "Testing alpha caplet calibration "
        ...
        alphaInitial = DoubleVector(numberOfRates, vars.alpha_)
        alphaMax = DoubleVector(numberOfRates, 1.0)
        alphaMin = DoubleVector(numberOfRates, -1.0)
        maximizeHomogeneity = false
        ...
        smm = PseudoRootFacade(swapPseudoRoots,
                               vars.rateTimes_,
