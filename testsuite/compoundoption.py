...
class CompoundOptionTest(unittest.TestCase):
    ...
    def testValues(self):
        ...
        for value in values:
            ...
            error = abs(calculated - value.npv)
            tolerance = value.tol
    ...
    def testPutCallParity(self):
        ...
        for value in values:
            ...
            compoundOptionCall = CompoundOption(
                payoffMotherCall, exerciseCompound,
                payoffDaughter, exerciseDaughter)

            compoundOptionPut = CompoundOption(
                payoffMotherPut, exerciseCompound,
                payoffDaughter, exerciseDaughter)
